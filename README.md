<p align="center"><img width="160" src="references/doc/lip_white.png" alt="logo"></p>
<h1 align="center">Visual Speech Recognition for Multiple Languages</h1>

<div align="center">

[ðŸ“˜Introduction](#Introduction) |
[ðŸ› ï¸Preparation](#Preparation) |
[ðŸ“ŠBenchmark](#Benchmark-evaluation) |
[ðŸ”®Inference](#Speech-prediction) |
...
:-------------------------------:|:------------------------------------:
<img src='references/doc/vsr_1.gif' title='vsr1' style='max-width:320px'></img>  |  <img src='references/doc/vsr_2.gif' title='vsr2' style='max-width:320px'></img>  |
...
- `./data/external/benchmarks/${dataset}/models`

- `./data/external/benchmarks/${dataset}/language_models`

5. [For VSR and AV-ASR] Install [RetinaFace](./references/tools) or [MediaPipe](https://pypi.org/project/mediapipe/) tracker.
...
- `[labels_filename]` is the labels path, located in `${lipreading_root}/data/external/benchmarks/${dataset}/labels`.
